;************************************************************************************************************************
;Program name: "Pure Assembly Practice".  This function takes in a string and returns a the size as an int.             *                                                                                   *
...
;
;Assemble: nasm -f elf64 -l strlen.lis -o strlen.o strlen.asm
;
;Date development began: 2022-October-26
;Date comments restructured: 2022-October-30
;
;int strlen (string x)
;Returns the size of string x
